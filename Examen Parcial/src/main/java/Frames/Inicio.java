...
public class Inicio extends javax.swing.JFrame {
    ...
    public Inicio() {
        ...
        TextPrompt usuario=new TextPrompt("Ingrese usuario",txtusuario);
        TextPrompt password=new TextPrompt("Ingrese su contraseña",this.txtpass);
    }
    ...
    private void initComponents() {
        ...
        Principal.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(196, 235, 255), 5, true));

        jPanel1.setBackground(new java.awt.Color(196, 235, 255));

        jLabel8.setText("\"DONDE HAY UN HERAUDINO HAY UN HOMBRE DE BIEN\"");

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/cerrar.png"))); // NOI18N
        jButton1.setContentAreaFilled(false);
        jButton1.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/cerrar.png"))); // NOI18N
        jButton1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/cerrar (1).png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/JH-Huancan.png"))); // NOI18N

        jLabel7.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel7.setText("Huancan");

        jLabel6.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel6.setText("I.E.\"JAVIER HERAUD\"");
        ...
        jPanel3.setBackground(new java.awt.Color(247, 91, 91));
        ...
        btminiciar.setBackground(new java.awt.Color(153, 0, 0));
        btminiciar.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btminiciar.setForeground(new java.awt.Color(255, 255, 255));
        btminiciar.setText("Iniciar Sesión");
        ...
        PrincipalLayout.setVerticalGroup(
            ...
            .addGroup(PrincipalLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btminiciar, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void btminiciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btminiciarActionPerformed
        ...
        if(!user.equals("") || !pass.equals("")) {
            ...
            try {
            PreparedStatement ps= cn.prepareStatement("SELECT tipo_nivel FROM usuarios WHERE username='"
                ...
                if(rs.next()){
                    ...
                    JOptionPane.showMessageDialog(null, "Usuario y/o contraceña incorrecta");
                    txtusuario.setText("");
                    txtpass.setText("");
                }
            ...
            JOptionPane.showMessageDialog(null, "Deve de rellenar todos los campos"); 
        }
